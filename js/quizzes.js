/* =========================================================
   quizzes.js — Timeline Renderer with Weeks Accordion
   ========================================================= */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const SECTION_KEY = 'quizzes';
    const STORE_KEY = 'soCompletedQuizzes';
    const THEME_COLOR = 'pink';
    const LABEL_PREFIX = 'Quiz Set';
            ...
            weeks: [
                {
                    ...
                    title: "Week 1",
                    lectures: [
                        { id: 1001, title: "Part 1: Overview", type: "pdf", url: "materials/dummy.pdf" },
                        { id: 1002, title: "Part 2: Concepts", type: "pdf", url: "materials/dummy.pdf" }
                    ]
                }
            ]
        }
            ...
            '<div class="chap-main-content relative z-10">' +
                ...
                '<div class="chap-meta">' +
                    ...
                    '<div class="chap-meta-item shadow-sm border border-' + THEME_COLOR + '-50/50">' +
                        ...
                        weeks.reduce((acc, w) => acc + (w.lectures || []).length, 0) + ' Quizzes' +
                    '</div>' +
                    (ch.time ? (
                    '<div class="chap-meta-item shadow-sm border border-' + THEME_COLOR + '-50/50">' +
