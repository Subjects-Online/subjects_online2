/* =========================================================
   qa.js — Timeline Renderer with Weeks Accordion
   ========================================================= */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const SECTION_KEY = 'qa';
    const STORE_KEY = 'soCompletedQA';
    const THEME_COLOR = 'amber';
    const LABEL_PREFIX = 'Part';
    const THEME_ACCENT = '#f59e0b';
    const THEME_GLOW = '#fcd34d';
    ...
    const defaultChapters = [
        {
            num: 1, title: "Q&A - Part One", time: "2h 15m",
            weeks: [
                {
                    num: 1,
                    title: "Week 1",
                    lectures: [
                        { id: 4001, title: "Part 1: Overview", type: "pdf", url: "materials/dummy.pdf" },
                        { id: 4002, title: "Part 2: Concepts", type: "pdf", url: "materials/dummy.pdf" }
                    ]
                }
            ]
        }
