/* =========================================================
   sections.js — Timeline Renderer with Weeks Accordion
   ========================================================= */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const STORE_KEY = 'soCompletedSections';
    const THEME_COLOR = 'purple';
    const LABEL_PREFIX = 'Section Set';
    const THEME_ACCENT = '#a855f7';
    const THEME_GLOW = '#d8b4fe';
            ...
            weeks: [
                {
                    ...
                    title: "Week 1",
                    lectures: [
                        { id: 2001, title: "Part 1: Overview", type: "pdf", url: "materials/dummy.pdf" },
                        { id: 2002, title: "Part 2: Concepts", type: "pdf", url: "materials/dummy.pdf" }
                    ]
                }
            ]
        }
            ...
            '<div class="chap-main-content relative z-10">' +
                ...
                '<div class="chap-meta">' +
                    ...
                    '<div class="chap-meta-item shadow-sm border border-' + THEME_COLOR + '-50/50">' +
                        ...
                        weeks.reduce((acc, w) => acc + (w.lectures || []).length, 0) + ' Sections' +
                    '</div>' +
                    (ch.time ? (
                    '<div class="chap-meta-item shadow-sm border border-' + THEME_COLOR + '-50/50">' +
